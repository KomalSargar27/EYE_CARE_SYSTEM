<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ManageDoctorRep.aspx.cs" Inherits="Reports_ManageDoctorRep" %>
        ...
        <tr>
            <td>
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <report filename="ManageDoctorRep.rpt">
                    </report>
