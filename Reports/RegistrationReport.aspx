<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="RegistrationReport.aspx.cs" Inherits="Reports_RegistrationReport" %>
        ...
        <tr>
            <td>
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="RegistrationRep.rpt">
                    </Report>
